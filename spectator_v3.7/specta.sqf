...
spectate_events = compile preprocessFileLineNumbers "spectator_v3.7\specta_events.sqf";
RefreshPlayerList = compile preprocessFileLineNumbers "spectator_v3.7\RefreshPlayerList.sqf";
FreeLookMovementHandler = compile preprocessFileLineNumbers "spectator_v3.7\FreeLookMovementHandler.sqf";
CameraMenuHandler = compile preprocessFileLineNumbers "spectator_v3.7\CameraMenuHandler.sqf";
PlayerMenuHandler = compile preprocessFileLineNumbers "spectator_v3.7\PlayerMenuHandler.sqf";
KEGsShowCombatMode = compile preprocessFileLineNumbers "spectator_v3.7\specta_combatmode.sqf";
KEGsShowUnitLocator = compile preprocessFileLineNumbers "spectator_v3.7\specta_locator.sqf";
